...
int main(int argc, char** argv) {
   ...
   cap.read(img);
    ...
    for(;;)
    {
       ...
       /*results frome kcf tracking*/
       cv::Rect rects;
       tracker.faceResult(img, rects);
       cv::rectangle(display_img, rects, cv::Scalar(0, 255, 0), 1);
       cl::FaceBox boxtemp(rects);
       windows.push_back(boxtemp);
